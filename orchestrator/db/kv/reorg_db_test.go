...
func TestStore_ReorgDB(t *testing.T) {
	...
	require.Equal(t, uint64(2), db.LatestSavedEpoch())
	require.Equal(t, uint64(50), db.LatestSavedVerifiedSlot())
	require.Equal(t, common.BytesToHash([]byte{uint8(100)}), db.LatestVerifiedHeaderHash())
